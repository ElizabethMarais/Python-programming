...
print "FUNCTION: Reading a data file, lists, sorting, and processing of data, different ways of displaying data.."
...
print "LIST: Print Projects names information extracted from the file in list form: "
print project_list      #e.g. [Proj num, city, project name]
...
print " "
#ask user to enter a word to check if there are several projects containing that word, e.g. 'Annlin', or 'Boardwalk'.
print "WORD SEARCH:"
word_dict = {}
while True:
...
print " "
print "SORTING: According to project numbers, ascending."
...
for i in range(len(projnew_list)):   #put back the 'N' at project numbers
    ...
    print projP, projnew_list[i][1], projnew_list[i][2]
